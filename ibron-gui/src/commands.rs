...
pub fn derive_command_from_key_assignment(action: &KeyAssignment) -> Option<CommandDef> {
    Some(match action {
        ...
        BlockFold => CommandDef {
            brief: "Fold focused block".into(),
            doc: "Collapses the output of the focused block (not yet implemented)".into(),
            keys: vec![],
            args: &[ArgType::ActivePane],
            menubar: &["View", "Blocks"],
            icon: None,
        ...
        BlockBookmark => CommandDef {
            brief: "Bookmark focused block".into(),
            doc: "Pins the focused block for quick recall (not yet implemented)".into(),
            keys: vec![],
            args: &[ArgType::ActivePane],
            menubar: &["View", "Blocks"],
            icon: None,
        ...
        BlockShare => CommandDef {
            brief: "Share focused block".into(),
            doc: "Shares the focused block (not yet implemented)".into(),
            keys: vec![],
            args: &[ArgType::ActivePane],
            menubar: &["Shell", "Blocks"],
            icon: None,
        ...
        BlockAskAI => CommandDef {
            brief: "Ask AI about focused block".into(),
            doc: "Sends the focused block to an AI assistant (not yet implemented)".into(),
            keys: vec![],
            args: &[ArgType::ActivePane],
            menubar: &["Shell", "Blocks"],
            icon: None,
        ...
        BlockSearchOpen => CommandDef {
            brief: "Search command blocks".into(),
            doc: "Opens a palette to search across command blocks (not yet implemented)".into(),
            keys: vec![],
            args: &[ArgType::ActivePane],
            menubar: &["View", "Blocks"],
            icon: None,
