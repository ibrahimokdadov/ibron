...
pub struct TermWindow {
    ...
    pub folded_blocks: HashMap<PaneId, std::collections::HashSet<ibron_blocks::BlockId>>,
    pub bookmarked_blocks: HashMap<PaneId, std::collections::HashSet<ibron_blocks::BlockId>>,
...
impl TermWindow {
    ...
    pub fn perform_key_assignment(
        ...
        match assignment {
            ...
            BlockFold => self.block_toggle_fold(pane),
            BlockBookmark => self.block_toggle_bookmark(pane),
            BlockShare => self.block_share(pane),
            BlockAskAI => self.block_ask_ai(pane),
            BlockSearchOpen => self.block_search_open(pane),
